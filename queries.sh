...
echo "$($PSQL "SELECT teams.name FROM games JOIN teams ON teams.team_id = games.winner_id OR teams.team_id = games.opponent_id WHERE games.year = 2014 AND games.round = 'Eighth-Final' ORDER BY teams.name")"
